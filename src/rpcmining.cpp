...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    //ChangedForRealPointCoin
	if (vNodes.empty())
        throw JSONRPCError(-9, "RealPointCoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "RealPointCoin is downloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    //ChangedForRealPointCoin
	if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "RealPointCoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "RealPointCoin is downloading blocks...");
